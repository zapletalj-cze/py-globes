...
shift_south = [
    Shift(ca_c_x + tools.Shift.shift_s(side_len), 5, ca_c_y - tools.Shift.shift_c(side_len), 5),
    Shift(ca_c_x + tools.Shift.shift_s(side_len), 11, ca_c_y - tools.Shift.shift_c(side_len)-tools.Shift.shift_d(side_len), 11)
]
...
Shift = namedtuple("Shift", ["x_value", "x_index", "y_value", "y_index"])
shift_south = [
    Shift(ca_c_x - tools.Shift.shift_s(side_len), 8, ca_c_y - tools.Shift.shift_c(side_len), 8),
    Shift(ca_c_x + tools.Shift.shift_s(side_len), 7, ca_c_y - tools.Shift.shift_c(side_len), 7),
    Shift(ca_c_x + tools.Shift.shift_s2(side_len), 6, ca_c_y + tools.Shift.shift_c2(side_len), 6),
    Shift(ca_c_x - tools.Shift.shift_s2(side_len), 9, ca_c_y + tools.Shift.shift_c2(side_len), 9),
]
...
for k, v in faces.items():
    ...
    if layer.supports("SHOWLABELS"):
        lc1 = layer.createLabelClass(name = 'Waterwways',
